...
void updateValueSynth(UBYTE p) {
  ...
  case 5:
    pu1Sus = dataSet[p];
    if (!dataSet[p] && !noteStatus[PU1_CURRENT_STATUS])
      NR12_REG = 0U;
    break;
  case 6:
  ...
  case 11:
    pu2Sus = dataSet[p];
    if (!dataSet[p] && !noteStatus[PU2_CURRENT_STATUS])
      NR22_REG = 0U;
    break;
  case 12:
  ...
  case 18:
    wavSus = dataSet[p];
    if (!dataSet[p] && !noteStatus[WAV_CURRENT_STATUS])
      NR32_REG = 0U;
    break;
  case 19:
  ...
  case 22:
    noiSus = dataSet[p];
    if (!dataSet[p] && !noteStatus[NOI_CURRENT_STATUS])
      NR42_REG = 0U;
    break;
  case 23:
